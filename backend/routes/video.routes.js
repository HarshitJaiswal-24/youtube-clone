...
videoRouter.put("/:id", authenticationUser,updateVideo);
// @route   DELETE /videos/:id - Delete video (auth required)
videoRouter.delete("/:id",authenticationUser, deleteVideo);
// @route   POST /videos/:id/like - Like a video (auth required)
videoRouter.post("/:id/like",authenticationUser, likeVideo);
// @route   POST /videos/:id/dislike - Dislike a video (auth required)
videoRouter.post("/:id/dislike", authenticationUser,dislikeVideo);
...
videoRouter.post('/upload',authenticationUser,
  upload.fields([
