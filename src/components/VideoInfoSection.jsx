...
export default function VideoInfoSection({ video }) {
    ...
    const handleLike = async () => {
        ...
        try {
            ...
            const res = await axios.post(`http://localhost:3000/videos/${video._id}/like`, {}, { withCredentials: true });
...
// Function to handle disliking a video
    const handleDislike = async () => {
        ...
        try {
            ...
            const res = await axios.post(`http://localhost:3000/videos/${video._id}/dislike`, {}, { withCredentials: true });
